...
export const CATEGORY_CONFIG: Record<CategorySlug, CategoryPageConfig> = {
    drinks: {
        ...
        slug: 'drinks',
        title: '음료',
        description: '다양한 음료 제품들을 한눈에 비교해 보세요.',
        categoryNo: 1,
    ...
    snacks: {
        ...
        slug: 'snacks',
        title: '과자',
        description: '과자 제품군의 인기 순위와 영양정보를 확인할 수 있습니다.',
        categoryNo: 2,
        defaultSort: 'productName,asc',
        pageSizeOptions: DEFAULT_PAGE_SIZE_OPTIONS,
        subCategories: [
    ...
    icecream: {
        ...
        slug: 'icecream',
        title: '아이스크림',
        description: '달콤한 아이스크림 브랜드와 맛을 비교해 보세요.',
        categoryNo: 3,
        defaultSort: 'productName,asc',
        pageSizeOptions: DEFAULT_PAGE_SIZE_OPTIONS,
...
export const NUTRITION_CONFIG: Record<NutritionSlug, NutritionPageConfig> = {
    'zero-calorie': {
        ...
        title: '제로 칼로리',
        description: '100g(ml)당 4kcal 미만의 제품들을 모아봤어요.',
        defaultSort: 'productName,asc',
        pageSizeOptions: DEFAULT_PAGE_SIZE_OPTIONS,
    ...
    'zero-sugar': {
        ...
        endpoint: 'zero-sugar',
        title: '제로 슈가',
        description: '100g(ml)당 0.5g 미만의 당류를 가진 제품들을 모아봤어요',
        defaultSort: 'productName,asc',
        pageSizeOptions: DEFAULT_PAGE_SIZE_OPTIONS,
    ...
    'low-calorie': {
        ...
        title: '저칼로리',
        description: '100g당 40kcal, 100ml당 20kcal 미만 제품들을 모아봤어요',
        defaultSort: 'productName,asc',
        pageSizeOptions: DEFAULT_PAGE_SIZE_OPTIONS,
    ...
    'low-sugar': {
        ...
        endpoint: 'low-sugar',
        title: '저당 식품',
        description: '100g당 5g, 100ml당 2.5g 미만 저당 제품들을 모아봤어요',
        defaultSort: 'productName,asc',
        pageSizeOptions: DEFAULT_PAGE_SIZE_OPTIONS,
